<script>
  import bill from "$lib/assets/07/images/bill.svg";
  import dollar from "$lib/assets/07/images/dollar.svg";
  import people from "$lib/assets/07/images/people.svg";
</script>
...
<section>
  <div class="wrapper">
    ...
    <div class="total-per-person">
      ...
      <div class="dollars">
        <sup>$</sup><span id="total-per-person">39.11</span>
      </div>
    </div>
...
<style>
  ...
  .bill-amount input[type="text"] {
    background: url("/src/lib/assets/07/images/dollar.svg") left 15px no-repeat;
    padding-left: 40px;
    width: 100%;
  }

  .number-of-people input[type="text"] {
    background: url("/src/lib/assets/07/images/people.svg") left 20px no-repeat;
    padding-left: 40px;
    text-align: right;
  }
