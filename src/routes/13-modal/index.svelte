<script>
  import bg from "$lib/assets/13/images/bg.jpg";
  import close from "$lib/assets/13/images/close.svg";
  import desk from "$lib/assets/13/images/desk.svg";
  import elgato_key_light from "$lib/assets/13/images/elgato-key-light.png";
</script>
...
<section>
  <div class="wrapper">
    ...
    >
      <image href={bg} width="1440" height="1024" />
      <a href="#" id="something">
        <circle
          class="dot"
          cx="136.5"
    ...
    <div class="overlay">
      <div class="modal">
        ...
        <div class="product-image">
          <img src={elgato_key_light} alt="Elgato Key Light" />
        </div>
      </div>
    </div>
  </div>
